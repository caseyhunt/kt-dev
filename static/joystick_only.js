if(typeof myp5 === 'undefined'){
  ...
  let joystick = function(p) {
    ...
    if(window.innerWidth<1120){
      scale = 0.35;
      console.log(scale);
      canvas_size = [450*scale,450*scale];
      center = [(450*scale)/2, (450*scale)/2];
    ...
    p.setup = function() {
      var myCanvas = p.createCanvas(canvas_size[0], canvas_size[1]);
    ...
    p.draw = function() {
      ...
      if(pressed == false){
        ...
        console.log("joystick moving " + joystickmoving);

      }

      //if(pressed == true && inCanvas ==true && insideTri == false){
      if(joystickmoving == true && insideTri == false){
        console.log("joystick moving " + joystickmoving);
      p.print(outx, outy);
...
let joystick1 = function(p) {
      ...
      p.draw = function() {
        ...
        if(typeof isconnected2 != 'boolean'){
          moveJoystick(1, outx, outy, true, undefined);
        }else {
        moveJoystick(1, outx, outy, false, undefined);
      }
      }else if(pressed == false&& inCanvas == true){
